                                                    ...
                                                    <nav aria-label="Page navigation">
                                                        <ul class="pagination">
                                                            <li class="page-item prev <?= $current_page == 1 ? 'disabled' : '' ?>">
                                                                <a class="page-link" href="<?= $current_page == 1 ? '#' : base_url('index.php/pencarian/kategori_buku/' . $id . '/' . ($current_page - 1)) ?>"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                                            </li>
                                                            <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                                                                <li class="page-item <?= $i == $current_page ? 'active' : '' ?>">
                                                                    <a class="page-link" href="<?= base_url('index.php/pencarian/kategori_buku/' . $id . '/' . $i) ?>"><?= $i ?></a>
                                                                </li>
                                                            <?php endfor; ?>
                                                            <li class="page-item next <?= $current_page == $total_pages ? 'disabled' : '' ?>">
                                                                <a class="page-link" href="<?= $current_page == $total_pages ? '#' : base_url('index.php/pencarian/kategori_buku/' . $id . '/' . ($current_page + 1)) ?>"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                                            </li>
                                                        </ul>
                                                    </nav>
