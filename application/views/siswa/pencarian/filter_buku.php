        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row mt-1">
                        <!-- <div class="col-md-3">
                            <form action="<?= site_url('pencarian/filter') ?>" method="post">
                                <div class="card mb-2">
                                    <h6 class="card-header fw-bold"> Filter Kategori Buku</h6>
                                    <div class="card-body">
                            ...
                            <div class="row ml-lg-2 mt-2 mb-2">
                                ...
                                ?>
                                    <div class="col-md-3 col-sm-3 col-lg-3 mb-1">
                                        <div class="card">
                                            <a class="card-header text-dark" href="<?= site_url('pencarian/kategori_buku/' . $val->id_kategori) ?>"><i class='bx bxs-book'></i> <?= $val->nama_kategori; ?></a>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        ...
                        <div class="col-md-9 mb-1">
                            <div class="row">
                                <div class="col-md-8 col-lg-8 col-sm-8 mb-1">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?= site_url("pencarian/pencarian_buku") ?>" method="get">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="<?= site_url('pencarian/pengurutan') ?>" method="get">
                                                    ...
                                                    <nav aria-label="Page navigation">
                                                        <ul class="pagination">
                                                            <li class="page-item prev <?= $current_page == 1 ? 'disabled' : '' ?>">
                                                                <a class="page-link" href="<?= $current_page == 1 ? '#' : base_url('index.php/pencarian/filter_buku?' . http_build_query(['kelas' => $kelas, 'rak' => $rak_filter, 'page' => $current_page - 1])) ?>"><i class="tf-icon bx bx-chevrons-left"></i></a>
                                                            </li>
                                                            <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                                                                <li class="page-item <?= $i == $current_page ? 'active' : '' ?>">
                                                                    <a class="page-link" href="<?= base_url('index.php/pencarian/filter_buku?' . http_build_query(['kelas' => $kelas, 'rak' => $rak_filter, 'page' => $i])) ?>"><?= $i ?></a>
                                                                </li>
                                                            <?php endfor; ?>
                                                            <li class="page-item next <?= $current_page == $total_pages ? 'disabled' : '' ?>">
                                                                <a class="page-link" href="<?= $current_page == $total_pages ? '#' : base_url('index.php/pencarian/filter_buku?' . http_build_query(['kelas' => $kelas, 'rak' => $rak_filter, 'page' => $current_page + 1])) ?>"><i class="tf-icon bx bx-chevrons-right"></i></a>
                                                            </li>
                                                        </ul>
                                                    </nav>
