            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?php echo site_url('siswapanel/login') ?>" method="POST">
                            <div class="mb-3">
                        ...
                        <p class="text-center">
                            <span><b>Belum Punya Username dan Password ??</b><a href="<?= site_url('siswapanel/kode_akses'); ?>"> Klik Kode akses</a> </span>
                        </p>
                    </div>
                </div>
                <!-- /Register -->
