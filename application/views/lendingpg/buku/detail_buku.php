                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 ">
                                        <div class="card-body">
                                            <img class="card-img-top w-100 h-100" src="<?= base_url('asset/fotobuku/IPS_BS_KLS_X_Rev_Cover.png') ?>" alt="">
                                        </div>
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="card-body">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    Buku ini telah dipinjaman <strong>100</strong> kali, dikembalikan sebanyak <strong>100</strong> kali.
                                                </p>
                                            </div>
                                            <div class="card-body">
                                                <div class="row mb-4">
